...
<body class="gray-bg">
	<div class="table_content" style="margin-bottom: 0px;">
		...
		<form id="form" name="form" action="wh/query.action"
			...
			<div id="div2" style="display:none;">
			 ...
			 <span style="height: 30px; line-height:30px; font-size: 14px;">井深(m)</span>
					...
					<select id="p801011" name="p801011" style="width:120px" onclick="" class="select_gray">
							<option value="">请选择</option>
					...
					<select id="p801022" name="p801022" style="width:120px" onclick="" class="select_gray">
							<option value="">请选择</option>
							<option value="农业灌溉">农业灌溉</option>
							<option value="乡村生活">乡村生活</option>
							<option value="城镇生活">城镇生活</option>
			...
			<div >
				...
				<div id="div3" class="but_blue" >开始查询</div>
				<div id="div4" class="but_blue" ><a style="text-decoration:none;color: #fff;" href="wh/toWellAdd.action" target="_blank">新增机井</a></div>
			</div>			
		</form>
	</div>
